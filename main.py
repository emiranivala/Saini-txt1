...
async def main():
    ...
    try:
        ...
        await stop_bot()
import random
keyboard = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/She_who_remain"),InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+3bMBj190KOc3YzNk")]])
Busy = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/She_who_remain"),InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+3bMBj190KOc3YzNk")]])
image_urls = ["https://graph.org/file/a06275c5b4e838e2df0e5-664ae5f4d543dfd30d.jpg","https://graph.org/file/a06275c5b4e838e2df0e5-664ae5f4d543dfd30d.jpg"]
...
async def document_handler(bot: Client, m: Message):
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:
                cc = f'**📤 Uploaded by :** {m.from_user.mention} [{res}].mp4\n**🔗 Video link :** <a href="{url}">__**CLICK HERE**__</a>\n\n**🌟 Extracted By : {CR}**'
                cc1 = f'**🔗 Link :** <a href="{url}">__**CLICK HERE**__</a>\n\n**🌟 Extracted By : 𝙲𝚁𝚄𝚂𝙷𝙴 𝘽𝙾𝚃𝚂**'
                if "drive" in url:
                    try:
                    ...
                    Error = f"⚠️ 𝐃𝐨𝐰𝐧ʟᴏᴀᴅɪɴɢ 𝐈ɴᴛᴇʀᴜᴘᴛᴇᴅ\n\n⚠️ 𝐍𝐚𝐦𝐞 » {name}\n"
...
async def link_handler(bot: Client, m: Message):
    ...
    if len(link_parts) > 1:
        ...
        await editable.edit("Invalid link format. Please include 'https://'.")
        return
    await editable.edit("**╭━━━━❰ᴇɴᴛᴇʀ ʀᴇꜱᴏʟᴜᴛɪᴏɴ❱━➣\n┣━━⪼ 🔹sᴇɴᴅ **144** for  144p\n┣━━⪼ 🔹sᴇɴᴅ **240** for  240p\n┣━━⪼ 🔹sᴇɴᴅ **360** for  360p\n┣━━⪼ 🔹sᴇɴᴅ **480** for  480p\n┣━━⪼ 🔹sᴇɴᴅ **720** for  720p\n┣━━⪼ 🔹sᴇɴᴅ **1080** for 1080p\n╰━━⌈⚡[🦋𝙲𝚁𝚄𝚂𝙷𝙴 𝘽𝙾𝚃𝚂🦋]⚡⌋━━➣ **")
    input2: Message = await bot.listen(editable.chat.id)
    raw_text2 = input2.text
    ...
    try:
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Error = f"⚠️ 𝐃𝐨𝐰ɴʟᴏᴀᴅɪɴɢ 𝐈ɴᴛᴇʀᴜᴘᴛᴇᴅ\n\n⚠️ 𝐍𝐚𝐦𝐞 » {name}\n"
                    await m.reply_text(Error, disable_web_page_preview=True)
                    count += 1
                    pass
    except Exception as e:
